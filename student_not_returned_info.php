  ...
  <marquee><h1>Welcome to the Library</h1></marquee>
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped" id="myTable">
        ...
        $status = "Not Returned";
        $sql = "select returned.status, returned.expiry_date, user.name as student_name, book.name as book_name from `returned` inner join `user` on returned.student_id = user.id inner join `book` on returned.book_id = book.id where student_id = '$student_id' && status = '$status'";
