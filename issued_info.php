  ...
  <marquee><h1>Welcome to the Library</h1></marquee>
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped" id="myTable">
        ...
        <?php
        $sql = "select issued.expiry_date, user.id as student_id, user.name, user.email, book.name as book_name, catagory.catagory from `issued` inner join `user` on issued.student_id = user.id inner join `book` on issued.book_id = book.id inner join `catagory` on issued.cat_id = catagory.id";
