  ...
  <marquee><h1>Welcome to the Library</h1></marquee>
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped" id="myTable">
        ...
        <?php
        $sql = "select returned.expiry_date, returned.id as ret_id, returned.status, user.id as student_id, user.name, user.email, book.name as book_name from `returned` inner join `user` on returned.student_id = user.id inner join `book` on returned.book_id = book.id ";
